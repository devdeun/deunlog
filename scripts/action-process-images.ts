...
Detected **${formatImages(metrics.totalFiles)}**
- Optimized: **${formatImages(metrics.sharpFiles)}**
- Converted to AVIF: **${metrics.avifConverted}**
- Total size reduction: **${metrics.savedPercent}%**
